 ...
 */
class RecordatorioFragment(userUid: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.mis_recordatorios, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            RecordatorioFragment("userUid").apply {
